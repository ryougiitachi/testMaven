...
public class Entry {
	...
	private static final void test(String weblink) {
		...
		String strTmpFilePath = GalleryUtils.joinStrings(builder, "html/", strURL.substring(strURL.lastIndexOf("/") + 1), ".html");
		URL url = null;
		...
		try {
			...
			sos = new BufferedOutputStream(new FileOutputStream(strTmpFilePath));
